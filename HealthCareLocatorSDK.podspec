#
#  Be sure to run `pod spec lint HealthCareLocatorSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # spec.source       = { :path => "." }
  spec.source  = { :git => 'https://github.com/hclsdk/HealthCareLocatorIOSSDK.git', :branch => 'master'}
  ...
  spec.source_files  = "HealthCareLocatorSDK", "HealthCareLocatorSDK/**/*.{swift}"
  ...
  spec.resources = "HealthCareLocatorSDK/**/*.{storyboard,xib,json,xcassets,strings}"
