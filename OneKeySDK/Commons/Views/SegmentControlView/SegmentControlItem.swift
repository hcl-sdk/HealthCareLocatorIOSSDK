...
class SegmentControlItem: UIView {
    ...
    private var item: SegmentControlModel = SegmentControlModel(icon: nil,
                                                            title: "Item",
    ...
    init(item: SegmentControlModel, index: Int, selected: Bool) {
    ...
    private func initialize() {
        if let nibView = Bundle.internalBundle().loadNibNamed("SegmentControlItem", owner: self, options: nil)?.first as? UIView {
    ...
    func layoutWith(item: SegmentControlModel, selected: Bool) {
