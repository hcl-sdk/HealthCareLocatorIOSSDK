...
extension SearchResultSortViewController: ViewDesign {
    ...
    func layoutWith(theme: OKThemeConfigure) {
        ...
        nameLabel.text = "onekey_sdk_name_item".localized
        resetButton.setTitle("onekey_sdk_reset_button".localized, for: .normal)
        applyButton.setTitle("onekey_sdk_apply_button".localized, for: .normal)
