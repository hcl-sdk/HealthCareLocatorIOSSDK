...
class SearchInputViewController: UIViewController, ViewDesign {
    ...
    func setupDataBinding() {
        ...
        Observable.zip(searchInputAutocompleteModelView.codesObservable(config: OKManager.shared),
                       searchInputAutocompleteModelView.individualsObservable(config: OKManager.shared))
