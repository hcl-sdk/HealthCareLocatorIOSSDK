#
#  Be sure to run `pod spec lint OneKeySDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "OneKeySDK"
  spec.version      = "0.0.1"
  spec.summary      = "OneKeySDK from IQVIA"
  ...
  spec.homepage     = "http://EXAMPLE/OneKeySDK"
  ...
  spec.source_files  = "OneKeySDK", "OneKeySDK/**/*.{swift}"
  ...
  spec.resources = "OneKeySDK/**/*.{storyboard,xib,json}"
