//
//  HCLManagerTests.swift
//  HealthCareLocatorSDKTests
//
//  Created by Truong Le on 12/30/20.
//

import XCTest
@testable import HealthCareLocatorSDK

class HCLManagerTests: XCTestCase {
    ...
    func testInitialize_WithAllParamsProvided_HandlerShouldBeCalledWithSuccessStateTrue() {
        // Arrange
        let mockAPIKey = "an_api_key"
        let mockConfig = HCLSearchConfigure(entry: .home, favourites: [])
        let expected = expectation(description: "Callback has has been call with success state is true")
    ...
    func testInitialize_WithWrongParamsProvided_HandlerShouldBeCalledWithSuccessStateFalse() {
        // Arrange
        let mockAPIKey = "an_api_key"
        let mockConfig = HCLSearchConfigure(entry: .home, favourites: ["SP.1", "SP.2"])
    ...
    func testSetSearchConfig_WithEmptyConfigObjectProvided_ManagerShouldRecordTheSearchConfig() {
        let searchConfig = HCLSearchConfigure()
    ...
    func testSetSearchConfig_WithSpecificConfigObjectProvided_ManagerShouldRecordTheSearchConfig() {
        let mockEntry = HCLSearchConfigure.SearchEntry.nearMe
        let mockSpeciaialities = ["SP.1", "SP.2"]
        let searchConfig = HCLSearchConfigure(entry: mockEntry, favourites: mockSpeciaialities)
        manager.configure(search: searchConfig)
    ...
    func testGetDefaultSearchConfigure_ManagerShouldReturnCorrectDefaultSearchConfiguretionObject() {
        ...
        let emptyConfig = HCLSearchConfigure()
    ...
    func testGetDefaultUIConfigure_ManagerShouldReturnCorrectConfiguredValues() {
        ...
        let titleMainFont: UIFont? = UIFont(name: "HelveticaNeue", size: 20.0)
        let titleSecondaryFont: UIFont? = UIFont(name: "HelveticaNeue-Medium", size: 16.0)
        let searchResultTotalFont: UIFont? = UIFont(name: "HelveticaNeue-Medium", size: 14.0)
        let searchResultTitleFont: UIFont? = UIFont(name: "HelveticaNeue", size: 16.0)
        let resultTitleFont: UIFont? = UIFont(name: "HelveticaNeue", size: 14.0)
        let resultSubTitleFont: UIFont? = UIFont(name: "HelveticaNeue", size: 14.0)
        let profileTitleFont: UIFont? = UIFont(name: "HelveticaNeue", size: 18.0)
        let profileSubTitleFont: UIFont? = UIFont(name: "HelveticaNeue", size: 16.0)
        let profileTitleSectionFont: UIFont? = UIFont(name: "HelveticaNeue", size: 16.0)
        let cardTitleFont: UIFont? = UIFont(name: "HelveticaNeue-Medium", size: 16.0)
        let modalTitleFont: UIFont? = UIFont(name: "HelveticaNeue", size: 18.0)
        let searchInputFont: UIFont? = UIFont(name: "HelveticaNeue", size: 16.0)
        let sortCriteriaFont: UIFont? = UIFont(name: "HelveticaNeue", size: 16.0)
        let buttonFont: UIFont? = UIFont(name: "HelveticaNeue", size: 14.0)
        let smallFont: UIFont? = UIFont(name: "HelveticaNeue", size: 12.0)
        let noResultTitleFont: UIFont? = UIFont(name: "HelveticaNeue", size: 20.0)
        let noResultDescFont: UIFont? = UIFont(name: "HelveticaNeue", size: 16.0)
        ...
        XCTAssertEqual(noResultTitleFont, defaultTheme.noResultTitleFont, "Expected default theme has correct small font value but received a different value")
        XCTAssertEqual(noResultDescFont, defaultTheme.noResultDescFont, "Expected default theme has correct small font value but received a different value")
